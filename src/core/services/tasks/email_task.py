...
@broker.task
async def send_email_task(recipient: str, subject: str, body: str, html_body: Optional[str] = None) -> bool:
    """TaskIQ task for sending emails"""
    logger.debug('in taskiq send_email_task')
    try:
